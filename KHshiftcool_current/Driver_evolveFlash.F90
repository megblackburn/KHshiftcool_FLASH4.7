...
subroutine Driver_evolveFlash()
  ...
  use Circuit_interface, ONLY : Circuit
...
#include "Flash.h"
 ...
 !! call Timers_start("Driver_s beginning") 
 !! call Driver_s()
 !! call Timers_stop("Driver_s end")
  ...
  do dr_nstep = dr_nBegin, dr_nend
     ...
     !!call Timers_start("Driver_s")
     call Driver_s()
     !!call Timers_stop("Driver_s")
 ...
 !    call Driver_s()
     ...
     do nstepSTS = 1,nstepTotalSTS_local
       ...
       !! Calling Circuit before diffusion
       call Circuit(dr_dt,dr_simTime)

#ifndef DRIVER_DIFFULAST
        ! 3. Diffusive processes: 
        !    Radiation, viscosity, conduction, & magnetic resistivity
